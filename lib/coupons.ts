...
//
// TIKTOK15: "follow our TikTok, get 15% off" growth incentive. Landed cost on
// the hero SKUs (device ~35rmb, starter kit device+30 bags ~60rmb, +domestic
// freight <20rmb) is a small fraction of the $75-95 retail price, so 15% off
// leaves a large margin over hard product cost — see 2026-09-21 discussion.
...
const COUPONS: Coupon[] = [
  { code: 'TIKTOK15', percentOff: 0.15, active: true, description: 'Follow @freshlocksealer on TikTok — 15% off' },
];
