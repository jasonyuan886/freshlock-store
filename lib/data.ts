...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: {
      'Model': 'PVS-02-SK30',
      'Includes': '1× FreshLock Pro (PVS-02), 10× Small Bags (22×21 cm), 10× Medium Bags (26×28 cm), 10× Large Bags (26×34 cm), 1× USB-C Cable, 1× Quick Start Guide',
